...
(function () {
    ...
    ns.imageDataCanvas = ns.imageDataCanvas || {}, ns.imageDataVideo = ns.imageDataVideo || {}; ns.imageDataVideo1 = ns.imageDataVideo1 || {};
    ...
    ns.drawEachCanvas = function (c) {
        ...
        ns.imageDataVideo1 = data;
        console.log("ns.imageDataVideo1 : " + ns.imageDataVideo1);
        ...
        imagesPage = ['<div data-role="page" id="imagesObjetRecyclable" data-add-back-btn="true">',
            ...
            '<div data-role="content">',
                ...
                '<form action="imageObjet" method="post">',
                    '<input id="donneeImage" name="donneeImage" type="hidden" value="" style="font-size:9pt; margin-top:0; margin-bottom:0; margin-left:auto; margin-right:auto; z-index:2000; pointer-events:none; border:0px;" />',
                    '<input id="donneeImage1" name="donneeImage1" type="hidden" value="" style="font-size:9pt; margin-top:0; margin-bottom:0; margin-left:auto; margin-right:auto; z-index:2000; pointer-events:none; border:0px;" />',
                    '<input id="largeurImage" name="largeurImage" type="hidden" value="" style="font-size:9pt; margin-top:0; margin-bottom:0; margin-left:auto; margin-right:auto; z-index:2000; pointer-events:none; border:0px;" />',                            
                    '<input id="hauteurImage" name="hauteurImage" type="hidden" value="" style="font-size:9pt; margin-top:0; margin-bottom:0; margin-left:auto; margin-right:auto; z-index:2000; pointer-events:none; border:0px;" />',
    ...
    ns.drawEachCanvasNewPage = function (c) {
         ...
         * */
       /* $('input#donneeImage1').val( ns.imageDataVideo.data);*/
        /*console.log("ns.imageDataVideo.data (DEMO): " + ns.imageDataVideo.data);*/
        $('input#donneeImage').val( JSON.parse( localStorage['dataVideo']));
        console.log("ns.imageDataVideo1(DEMO): " + localStorage['dataVideo']);
